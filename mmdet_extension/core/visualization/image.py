...
#split1:['chimney', 'dam', 'Expressway-Service-area','Expressway-toll-station', 'vehicle', 'groundtrackfield', 'overpass','stadium', 'tenniscourt', 'trainstation']
    #-------------------------------------------------------

    max_label = int(max(labels) if len(labels) > 0 else 0)
#     text_palette = palette_val(get_palette(text_color, max_label + 1))
    text_palette = palette_val(get_palette(palette, max_label + 1))
    ...
    if bboxes is not None:
        ...
        bbox_palette = palette_val(get_palette(palette, max_label + 1))
